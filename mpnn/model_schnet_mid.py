...
class Net(torch.nn.Module):
    def __init__(self, node_dim=13, edge_dim=5, num_target=8, num_gaussians=50):
        ...
        self.interaction = InteractionBlock(128, num_gaussians,
                                     128, 10.0)
    ...
    def forward(self, node, edge, edge_index, node_index, coupling_index):
        ...
        for i in range(self.num_propagate):
            ...
            node = self.interaction(node, edge_index_schnet, edge_weight, edge_attr)
